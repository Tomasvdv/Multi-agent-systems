...
class Statistics():
	...
	def __init__(self, model):
		...
		self.friendly_planes_shot_epoch_counter = 0
		self.friendly_planes_in_range = 0
		self.enemy_planes_in_range = 0
		self.init = 1
		self.model = model
